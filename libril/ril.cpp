...
*/
    switch(request) {
        ...
        case RIL_REQUEST_OEM_REQUEST_BASE: return "OEM_REQUEST_BASE";
        ...
        case RIL_REQUEST_DIAL_EMERGENCY_CALL: return "DIAL_EMERGENCY";
        ...
        case RIL_UNSOL_RESPONSE_LINE_SMS_COUNT: return "RIL_UNSOL_RESPONSE_LINE_SMS_COUNT";
        case RIL_UNSOL_RESPONSE_LINE_SMS_READ: return "RIL_UNSOL_RESPONSE_LINE_SMS_READ";
